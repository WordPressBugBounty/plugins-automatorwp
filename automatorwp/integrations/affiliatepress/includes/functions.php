 ...
 * Functions
 *
 * @package     AutomatorWP\Integrations\AffilatePress
 * @since       1.0.0
 */
 ...
 */
function automatorwp_affiliatepress_get_user_id ( $affiliate_id ) {
 ...
 * @param int $payout_id 
 */
function automatorwp_affiliatepress_get_affiliate_id_by_payout ( $payout_id ) {
