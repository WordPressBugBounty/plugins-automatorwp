 ...
 *
 * @package     AutomatorWP\Integrations\BBForms\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_BBForms_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'bbforms';
    public $trigger = 'bbforms_anonymous_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'action'            => 'bbforms_form_submit_success',
            ...
            'options'           => array(
                'post' => automatorwp_utilities_ajax_selector_option( array(
                    ...
                    'action_cb'         => 'automatorwp_bbforms_get_forms',
                    'options_cb'        => 'automatorwp_bbforms_options_cb_form',
                    'default'           => 'any'
                ) ),
     ...
     */
    public function listener( $bbforms_form, $bbforms_request, $bbforms_response ) {
        ...
        $form_fields = automatorwp_bbforms_get_form_fields_values( $bbforms_request );
...
new AutomatorWP_BBForms_Anonymous_Submit_Form();