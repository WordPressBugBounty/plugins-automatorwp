 ...
 *
 * @package     AutomatorWP\Integrations\Brizy\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_Brizy_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'brizy';
    public $trigger = 'brizy_anonymous_submit_form';
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'options'           => array(
                'post' => automatorwp_utilities_ajax_selector_option( array(
                    ...
                    'action_cb'         => 'automatorwp_brizy_get_forms',
                    'options_cb'        => 'automatorwp_brizy_options_cb_form',
                    'default'           => 'any'
                ) ),
     ...
     * @param stdClass $form
     */
    public function listener( $fields, $form ) {
        ...
        $form_id = $form->getId();
        $form_fields = automatorwp_brizy_get_form_fields_values( $fields );
...
new AutomatorWP_Brizy_Anonymous_Submit_Form();