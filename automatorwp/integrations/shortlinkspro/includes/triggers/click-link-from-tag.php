<?php
/**
 * Click a link from a tag
 *
 * @package     AutomatorWP\Integrations\ShortLinksPro\Triggers\Click_Link_From_Tag
...
class AutomatorWP_ShortLinksPro_Click_Link_From_Tag extends AutomatorWP_Integration_Trigger {

    public $integration = 'shortlinkspro';
    public $trigger = 'shortlinkspro_click_link_from_tag';
    ...
    public function register() {
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User clicks a link from a tag', 'automatorwp' ),
            'select_option'     => __( 'User clicks <strong>a link</strong> from a tag', 'automatorwp' ),
    ...
    public function listener( $link, $parameters, $url ) {
        ...
        $tags = automatorwp_shortlinkspro_get_tags_from_link( $link_id );
    ...
    public function user_deserves_trigger( $deserves_trigger, $trigger, $user_id, $event, $trigger_options, $automation ) {
        ...
        if( $trigger_options['post'] !== 'any' && absint( $event['tag_id'] ) !== absint( $trigger_options['post'] ) ) {
            return false;
        }
...
new AutomatorWP_ShortLinksPro_Click_Link_From_Tag();