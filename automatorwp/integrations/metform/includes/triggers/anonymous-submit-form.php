 ...
 *
 * @package     AutomatorWP\Integrations\MetForm\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_MetForm_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'metform';
    public $trigger = 'metform_anonymous_submit_form';
    ...
    public function listener( $form_id, $form_data, $form_settings, $attributes ) {
        ...
        $form_fields = automatorwp_metform_get_form_fields_values( $form_data );
...
new AutomatorWP_MetForm_Anonymous_Submit_Form();