 ...
 * Functions
 *
 * @package     AutomatorWP\MetForm\Functions
 * @since       1.0.0
 */
 ...
 * @return array
 */
function automatorwp_metform_get_form_fields_values( $fields ) {
 ...
 * @return string
 */
function automatorwp_metform_parse_automation_tags( $parsed_content, $replacements, $automation_id, $user_id, $content ) {
...
add_filter( 'automatorwp_parse_automation_tags', 'automatorwp_metform_parse_automation_tags', 10, 5 );