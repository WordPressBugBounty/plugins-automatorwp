...
final class AutomatorWP_Integration_Asgaros_Forum {

    /**
     * @var         AutomatorWP_Integration_Asgaros_Forum $instance The one true AutomatorWP_Integration_Asgaros_Forum
     * @since       1.0.0
     */
     ...
     * @access      public
     * @since       1.0.0
     * @return      AutomatorWP_Integration_Asgaros_Forum self::$instance The one true AutomatorWP_Integration_Asgaros_Forum
     */
    public static function instance() {
        if( ! self::$instance ) {

            self::$instance = new AutomatorWP_Integration_Asgaros_Forum();
    ...
    private function pro_installed() {
        ...
        if ( ! class_exists( 'AutomatorWP_Asgaros_Forum' ) ) {
            return false;
        }
...
/**
 * The main function responsible for returning the one true AutomatorWP_Integration_Asgaros_Forum instance to functions everywhere
 *
 * @since       1.0.0
 * @return      \AutomatorWP_Integration_Asgaros_Forum The one true AutomatorWP_Integration_Asgaros_Forum
 */
function AutomatorWP_Integration_Asgaros_Forum() {
    return AutomatorWP_Integration_Asgaros_Forum::instance();
}
add_action( 'automatorwp_pre_init', 'AutomatorWP_Integration_Asgaros_Forum' );
