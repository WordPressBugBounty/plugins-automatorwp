 ...
 *
 * @package     AutomatorWP\Integrations\EverestForms\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_Everest_Forms_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'everest_forms';
    public $trigger = 'everest_forms_anonymous_submit_form';
...
new AutomatorWP_Everest_Forms_Anonymous_Submit_Form();